...
class RenderUtils {
	...
	static function do_actions( $post_id, $sub_key, $arg1 = null, $arg2 = null, $arg3 = null, $arg4 = null ) {
		if ( Plugin::$fs->is_plan__premium_only( "pro", true ) ) {
			$prefix = Plugin::$slug;
			do_action( $prefix . "-all-" . $sub_key, $arg1, $arg2, $arg3, $arg4 );
			do_action( $prefix . "-" . $post_id . "-" . $sub_key, $arg1, $arg2, $arg3, $arg4 );
		}
	}

	static function apply_filters( $sub_key, $value, $arg2 = null, $arg3 = null, $arg4 = null ) {
		if ( Plugin::$fs->is_plan__premium_only( "pro", true ) ) {
			$prefix = Plugin::$slug . "_filter";
			return apply_filters( $prefix . "-" . $sub_key, $value, $arg2, $arg3, $arg4 );
		} else {
		    return $value;
		}
	}
