...
class DisplaySettings {
	...
	public function get_toggle_settings() {
		...
		$settings = [
			...
			"toggle_icon_custom_class" => [
				...
				"description" => Utils::t( "For example, FontAwesome icons should be like \"fa fa-angle-down\". " )
				                 . Utils::t( "Important Note: you should include custom icons pack in your theme by yourself" ),
	...
	public function get_posts_count_settings() {
		return [
			...
			"posts_count_calc_type"  => [
				...
				"options"     => [
					[ "id" => "as_is", "label" => Utils::t( "Show \"as is\"" ) ],
					[ "id" => "pad_count", "label" => Utils::t( "Sum children (pad_count)" ) ],
				],
				"default"     => "as_is",
			],
			"display_zero_count"  => [
				...
				"options"     => [
					[ "id" => "show", "label" => Utils::t( "Show" ) ],
					[ "id" => "hide", "label" => Utils::t( "Hide" ) ],
				],
				"default"     => "show",
			],
			"stretch_text"        => [
	...
	private function get_image_placeholder_type_options() {
		$options = [
			...
			[ "id" => "default", "label" => Utils::t( "Show default placeholder" ) ]
		];
