	...
	public function __construct() {
		$this->settings = [
			...
			"link_sharp_setting"       => [
				...
				"description" => Utils::t(
					"Empty links (#) turn into a static span-element"
				),
				"default"     => true,
				"depends_on"  => "source",
				"show_if"     => "menu"
			...
			"include_type"             => [
				...
				"options"     => [
					[ "id" => "no_children", "label" => Utils::t( "No children" ) ],
					[ "id" => "with_children", "label" => Utils::t( "With children" ) ]
				],
				"description" => Utils::t(
					"Whether to include terms with children or not."
				),
				"default"     => "no_children",
				"depends_on"  => "source",
				"show_if"     => "taxonomy"
			...
			"show_current_terms_tree"  => [
				...
				"description" => Utils::t(
					"Allows to retrieve all taxonomy elements that are children of the currently viewing element. The entire menu will be displayed if the currently viewed element has no sub-elements."
				),
				"default"     => false,
				"depends_on"  => "source",
				"show_if"     => "taxonomy",
			...
			"faq_groups"               => [
				...
				"label"       => Utils::t( "Group" ),
				"description" => Utils::t(
					"Select a group to show certain elements"
				),
				"default"     => "all",
		...
		if ( IKSM\iks_menu_fs()->is_plan__premium_only( "pro", true ) ) {
			$this->settings = Utils::clear_options_pro_flag__premium_only( $this->settings );
		}
	}
